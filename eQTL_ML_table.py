...
isQTLVectorTableFilename = sys.argv[2]
isQTLVectorTableFile = open(isQTLVectorTableFilename, 'r')

# store column lables in header row
headerLine = isQTLVectorTableFile.readline()
...
# create data structures for the different snp types --> key = snp, value = isQTL vector
lipidTestingSnps = {}
lipidTrainingSnps = {}
T2DLikeTestingSnps = {}
T2DLikeTrainingSnps = {}
...
# populate isQTL vector dictionary
for line in isQTLVectorTableFile:
	line = line.rstrip('\r\n')
	columns = line.split('\t')
...
# create output files
lipidTestingOutFilename = "lipid_testing_onlyQTL_ML_table.txt"
lipidTrainingOutFilename = "lipid_training_onlyQTL_ML_table.txt"
T2DLikeTestingOutFilename = "T2D_testing_onlyQTL_ML_table.txt"
T2DLikeTrainingOutFilename = "T2D_training_onlyQTL_ML_table.txt"
