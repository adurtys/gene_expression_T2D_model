...
python ./expression_lookup_new2019.py $snpFile $geneAnnotationsFile $tStatFile $numNearestGenesToSearch $distanceFromSnp $expressionThreshold $outFile $nearestGenesFile $processMissingSnps
