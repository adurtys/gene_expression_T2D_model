...
trait1_test  <-read.delim(file=paste(directory,"/",trait1,"_testing_",model,"_ML_table.txt",sep=""))

trait2_train <-read.delim(file=paste(directory,"/",trait2,"_training_",model,"_ML_table.txt",sep=""))
trait2_test  <-read.delim(file=paste(directory,"/",trait2,"_testing_",model,"_ML_table.txt",sep=""))
