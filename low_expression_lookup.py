...
# argv6: the percent of bottom ranks of t-statistic that should be considered as having "low expression" for each tissue (expressed as a 
...
# determine whether expression rank meets threshold for low expression
